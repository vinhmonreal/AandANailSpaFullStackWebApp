...
app.post(`${api}/admin/createnail`, CreateNewNail);
app.delete(`${api}/admin/removenail`, RemoveNail);
app.get(`${api}/admin/nails`, GetAllNails);
app.put(`${api}/admin/updatenail`, UpdateNail);

app.post(`${api}/admin/createHomepage`, CreateNewHomepage);
app.put(`${api}/admin/updateHomepage`, UpdateHomePage);
app.get(`${api}/admin/homepage`, GetHomepage);
